      ...
      .then((data) => {
        if (data && data.branding) {
          const fetchedSettings: StoreSettings = {
            ...
            bannerSlidesBig:   Array.isArray(data.bannerSlidesBig)   ? data.bannerSlidesBig   : [],
            bannerSlidesSmall: Array.isArray(data.bannerSlidesSmall) ? data.bannerSlidesSmall : [],
            bentoTiles:        Array.isArray(data.bentoTiles)        ? data.bentoTiles        : [],
            bentoTitle:        data.bentoTitle ?? "",
            bentoType:         data.bentoType ?? "category",
            bentoBannerImage:  data.bentoBannerImage ?? "",
            bentoBannerLink:   data.bentoBannerLink ?? "",
            homepageLayout:    Array.isArray(data.homepageLayout) ? data.homepageLayout : [],
